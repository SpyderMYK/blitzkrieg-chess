...
After a game vs the Computer ends, a **Review Game** button appears in the game-over popup. Click it to enter replay mode:

- The full board is revealed (both sides visible)
- Use **← Prev** and **Next →** to step through every move
- The from/to squares of each move are highlighted in yellow
- The counter shows which move you're viewing out of the total
- Click **✕ Exit Review** to return to the post-game board
